...
extends ManagedChannelBuilder<T> {
    ...
    public static ManagedChannelBuilder<?> forAddress(String string, int n) {
        throw new UnsupportedOperationException("Subclass failed to hide static factory");
    }

    public static ManagedChannelBuilder<?> forTarget(String string) {
        throw new UnsupportedOperationException("Subclass failed to hide static factory");
    }
    ...
    public T defaultLoadBalancingPolicy(String string) {
        this.delegate().defaultLoadBalancingPolicy(string);
        return this.thisT();
    }
    ...
    public T overrideAuthority(String string) {
        this.delegate().overrideAuthority(string);
        return this.thisT();
    }
    ...
    @Deprecated
    public T usePlaintext(boolean bl) {
        this.delegate().usePlaintext(bl);
        return this.thisT();
    }
    ...
    public T userAgent(String string) {
        this.delegate().userAgent(string);
        return this.thisT();
    }
}
