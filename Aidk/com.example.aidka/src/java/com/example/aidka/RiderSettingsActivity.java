...
public class RiderSettingsActivity
extends AppCompatActivity {
    ...
    private void getUserInfo() {
        this.mRiderDatabase.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0L) {
                    ...
                    if (map.get((Object)"name") != null) {
                        RiderSettingsActivity.this.mName = map.get((Object)"name").toString();
                        RiderSettingsActivity.this.mNamefield.setText((CharSequence)RiderSettingsActivity.this.mName);
                    }
                    if (map.get((Object)"phone") != null) {
                        RiderSettingsActivity.this.mPhone = map.get((Object)"phone").toString();
                        RiderSettingsActivity.this.mPhonefield.setText((CharSequence)RiderSettingsActivity.this.mPhone);
                    }
                    if (map.get((Object)"profilImageUri") != null) {
                        RiderSettingsActivity.this.profileuri = map.get((Object)"profilImageUri").toString();
                        Glide.with((Context)RiderSettingsActivity.this.getApplicationContext()).load(RiderSettingsActivity.this.profileuri).into(RiderSettingsActivity.this.profileImage);
                    }
                }
            }
        });
    ...
    private void saveUserInformation() {
        ...
        this.mRiderDatabase.updateChildren((Map)hashMap);
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    storageReference.getDownloadUrl().addOnSuccessListener((OnSuccessListener)new OnSuccessListener<Uri>(){
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            RiderSettingsActivity.this.mRiderDatabase.updateChildren((Map)hashMap);
                            RiderSettingsActivity.this.progressBar.setVisibility(4);
                            Intent intent = new Intent((Context)RiderSettingsActivity.this, RiderMapActivity.class);
                            RiderSettingsActivity.this.startActivity(intent);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.mNamefield = (EditText)this.findViewById(2131165312);
        this.mPhonefield = (EditText)this.findViewById(2131165325);
        this.profileImage = (ImageView)this.findViewById(2131165327);
        this.progressBar = (ProgressBar)this.findViewById(2131165329);
        this.progressBar.bringToFront();
        this.progressBar.setVisibility(4);
        this.mAuth = FirebaseAuth.getInstance();
        this.userid = this.mAuth.getCurrentUser().getUid();
        this.mRiderDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Rider").child(this.userid);
        this.getUserInfo();
        this.profileImage.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                RiderSettingsActivity.this.startActivityForResult(intent, 1);
            }
        });
    }
